...
public class CourseRegistrationDatabaseTest {
    ...
    public void testRegisterSingle() {
        ...
        try {
            ...
            registrationDao.delete(studentid, DAOUtility.TERMID_FA25);

            // register for one course

            boolean result = registrationDao.create(studentid, DAOUtility.TERMID_FA25, 10520);
            ...
            assertEquals(r1, (JsonArray)Jsoner.deserialize(registrationDao.list(studentid, DAOUtility.TERMID_FA25)));
    ...
    public void testRegisterMultiple() {
        ...
        try {
            ...
            for (int i = 0; i < crn.length; ++i) {
                ...
                boolean result = registrationDao.create(studentid, DAOUtility.TERMID_FA25, crn[i]);
            ...
            JsonArray t1 = (JsonArray)Jsoner.deserialize(registrationDao.list(studentid, DAOUtility.TERMID_FA25));
    ...
    public void testDropSingle() {
        ...
        try {
            ...
            boolean result = registrationDao.delete(studentid, DAOUtility.TERMID_FA25, 10568);
    ...
    public void testDropMultiple() {
        ...
        try {
            ...
            result = registrationDao.delete(studentid, DAOUtility.TERMID_FA25, 12615);
    ...
    public void testWithdraw() {
        ...
        try {
            ...
            boolean result = registrationDao.delete(studentid, DAOUtility.TERMID_FA25);
